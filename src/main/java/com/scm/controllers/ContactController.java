...
public class ContactController {
    ...
    public String saveContact(@Valid @ModelAttribute ContactForm contactForm, BindingResult result, Authentication authentication, HttpSession session){
        ...
        //4. set the message to be displayed on view
    ...
    public String searchHandler(
        ...
        // Error comes from here.  Initially it is null
        ...
        if ("name".equalsIgnoreCase(contactSearchForm.getField())) {
            pageContact = contactService.searchByName(contactSearchForm.getValue(), size, page, sortBy, direction, user);
        } else if ("email".equalsIgnoreCase(contactSearchForm.getField())) {
            pageContact = contactService.searchByEmail(contactSearchForm.getValue(), size, page, sortBy, direction, user);
        } else if ("phone".equalsIgnoreCase(contactSearchForm.getField())) {
